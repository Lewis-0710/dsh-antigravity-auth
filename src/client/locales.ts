...
export const en = {
  ...
  singleAccount: 'One active account at a time. This bundle does not provide an account pool or quota rotation.',
  ...
  privacyNotice: 'Share Antigravity session and Antigravity model routing. Select this account to refresh and use account quota.',
  relogin: 'Log in again with Google',
  authCardTitle: 'Login',
  authCardIntro: 'Share Antigravity session and Antigravity model routing. Select this account to refresh and use account quota.',
  ...
  window5hTitle: '{hours}h {minutes}m {seconds}s after refresh',
  windowWeeklyTitle: '{days}d {hours}h {minutes}m after refresh',
  quotaFooterNotice: 'Select this account to refresh and use account quota',
  refreshStatus: 'Refresh quota',
  remaining: 'remaining',
  refreshesIn: 'Refreshes in',
  accountsListTitle: 'Logged-in Accounts',
  addAccount: 'Add Google Account',
  activeAccount: 'Active',
  switchAccountFailed: 'Failed to switch account',
  switchAccountToViewQuota: 'Select this account to load quota',
...
export const zh: Record<AntigravityAuthKey, string> = {
  ...
  singleAccount: '同一时刻只有一个活动账号。本能力包不提供账号池或额度轮换。',
  ...
  privacyNotice: '共享 Antigravity 登录态与Antigravity 模型路由，选中此账号以刷新并使用账号配额。',
  relogin: '重新登录 Google',
  authCardTitle: '登录',
  authCardIntro: '共享 Antigravity 登录态与Antigravity 模型路由，选中此账号以刷新并使用账号配额。',
  ...
  window5hTitle: '{hours}小时{minutes}分{seconds}秒后刷新',
  windowWeeklyTitle: '{days}天{hours}小时{minutes}分后刷新',
  quotaFooterNotice: '选中此账号以刷新并使用账号配额',
  refreshStatus: '刷新配额',
  remaining: '剩余',
  refreshesIn: '后刷新',
  accountsListTitle: '已登录账号',
  addAccount: '添加Google账号',
  activeAccount: '当前使用中',
  switchAccountFailed: '切换账号失败。',
  switchAccountToViewQuota: '选中此账号以加载并使用该账号配额',
  removeAccount: '移除',
